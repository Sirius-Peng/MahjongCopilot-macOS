...
from common.utils import resource_file, Folder
...
class ToggleSwitch(tk.Frame):
    ...
    def __init__(self, master, text:str, height:int, font_size:int = 12, command:Callable=None):
        ...
        img_ht = height*0.4
        img_on = tk.PhotoImage(file=resource_file(Folder.RES,'switch_on.png'))
        img_off = tk.PhotoImage(file=resource_file(Folder.RES,'switch_off.png'))
        img_mid = tk.PhotoImage(file=resource_file(Folder.RES,'switch_mid.png'))
...
class ToolBar(tk.Frame):
    ...
    def add_button(self, text:str, img_file:str, command) -> tk.Button:
        ...
        img = tk.PhotoImage(file=resource_file(Folder.RES, img_file))
